    ...
    <div class="container w-25 border m-auto mt-2">
        ...
        <form action="controller/LoginController.php" method="POST" class="form-group">
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" id="exampleFromControlInput1" placeholder="Enter E_mail" >
                <?php
            ...
            <div class="mb-3">
                ...
                <input type="password" name="password" class="form-control" id="exampleFromControlInput1" placeholder="Enter Password" >
                <?php
